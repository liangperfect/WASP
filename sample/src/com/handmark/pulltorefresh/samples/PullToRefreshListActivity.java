...
public final class PullToRefreshListActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// TextView footerView = new TextView(PullToRefreshListActivity.this);
		// RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(new
		// LayoutParams(LayoutParams.WRAP_CONTENT,
		// LayoutParams.WRAP_CONTENT));
		// footerView.setText("我是末尾的TextView");
		...
		final ListView testListView = actualListView;
		actualListView.post(new Runnable() {
			...
			public void run() {
				...
				System.out
						.println("actualListView.getLastVisiblePosition()-->>"
								+ testListView.getLastVisiblePosition()
								+ "   actualListView.getFirstVisiblePosition()-->>"
								+ testListView.getFirstVisiblePosition());
				System.out.println("testListView.getCount()-->>"
						+ testListView.getCount()
						+ "    testListView.getChildCount()-->>"
						+ testListView.getChildCount());
				View footerView = LayoutInflater.from(
						PullToRefreshListActivity.this).inflate(
						R.layout.load_more, null);
				if (testListView.getCount() != testListView.getChildCount()) {
					testListView.addFooterView(footerView);
				}
		...
		int countNums = actualListView.getChildCount();

		// System.out.println("visibleCountMums-->>" + visibleCountMums
		// + "  countNums-->>" + countNums);
		// if (visibleCountMums != countNums) {
		// View footerView = LayoutInflater.from(
		// PullToRefreshListActivity.this).inflate(R.layout.load_more,
		// null);
	...
	private String[] mStrings = { "Abbaye de Belloc",
			"Abbaye du Mont des Cats", "Abbaye du Mont des Cats",
			"Abbaye du Mont des Cats", "Abbaye du Mont des Cats",
			"Abbaye du Mont des Cats", "Abbaye du Mont des Cats",
			"Abbaye du Mont des Cats", "Abbaye du Mont des Cats",
			"Abbaye du Mont des Cats", "Abbaye du Mont des Cats",
